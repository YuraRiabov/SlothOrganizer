...
import { deleteAvatar, saveAvatar, updateFirstName, updateLastName, updatePassword, updatePasswordFailure, updatePasswordSuccess } from '@store/actions/profile.actions';
